...
WordPress で Contact Form 7 を使用する際によく使います。
...
<table class="inquiry">
	...
	<tr>
		...
		<td>
			[textarea* your-message class:content placeholder
...
[【コピペ OK】ContactForm7 のシンプルなデザインカスタマイズ](/posts/contactform7-simple-customize/)
